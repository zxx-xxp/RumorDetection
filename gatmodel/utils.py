...
def load_vocab_len(dataset="twitter15"):
    with open('H:/zxx/BiGCN/HGATRD/dataset/{}/{}_vocab.txt'.format(dataset, dataset), 'rb') as f:
        lines = f.readlines()
...
def load_data(dataset="twitter15"):
    ...
    for i in range(len(names)):
        with open('H:/zxx/BiGCN/HGATRD/dataset/{}/ind.{}.{}'.format(dataset, dataset, names[i]), 'rb') as f:
...
def load_user_tweet_graph(dataset, elapsed_time, tweets_count):
    ...
    for i in range(len(names)):
        if elapsed_time == 3000 and tweets_count == 500:
            path = 'H:/zxx/BiGCN/HGATRD/dataset/{}/ind.{}.user.tweet.{}'.format(dataset, dataset, names[i])
        elif elapsed_time != 3000 and tweets_count == 500:
            path = 'H:/zxx/BiGCN/HGATRD/dataset/{}/ind.{}.user.tweet.{}.et{}'.format(dataset, dataset, names[i], elapsed_time)
        elif elapsed_time == 3000 and tweets_count != 500:
            path = 'H:/zxx/BiGCN/HGATRD/dataset/{}/ind.{}.user.tweet.{}.tc{}'.format(dataset, dataset, names[i], tweets_count)
